const local: App.I18n.Schema = {
  system: {
    name: 'JuAI',
    title: 'Ju AI, an essential AI integration tool in work and life',
    shortTitle: 'JuAI essential AI tool'
  },
  common: {
    action: 'Action',
    add: 'Add',
  ...
  route: {
    ...
    drawing: "drawing",
    drawing_home: "drawing list",
    drawing_tool: "drawing image",
    invite: "invite and pay",
    invite_user: "invite users",
    invite_pay: "pay upgrade",
  ...
  page: {
    login: {
      common: {
        ...
        userNamePlaceholder: 'Please enter phone number or email',
    ...
    home: {
      ...
      invitedPeoples: "invited peoples",
      notice: "notice",
      nextPage: "next page",
      prePage: "pre page"
    },
  ...
  chat: {
    ...
    turnOnAsyncDb: 'In the current mode, will sync to cloud.',
    turnOffAsyncDb: 'In the current mode, will not sync to cloud',

...
<template>
  ...
  >
    ...
    <div id="loginCard" :bordered="false" class="relative z-4 w-auto rd-12px">
      <div class="w-400px lt-sm:w-300px">
        <header class="flex-y-center justify-between">
          <!-- <SystemLogo class="text-64px text-primary lt-sm:text-48px" /> -->
          <img src="@/assets/index.png" style="object-fit: cover;width:80px;height: 80px;" />
...
<style scoped>
#loginCard {
  background-color: rgb(225 219 219 / 31%);
  padding: 50px;
}
</style>
